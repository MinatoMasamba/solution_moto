...
- **IMPORTANT**: If the task involves user interfaces or dashboards, you MUST ensure all theme elements, user details (e.g., profiles, ratings, trip history), and interactive features (e.g., booking, mobile money integration) from the design specifications are implemented and connected to the backend.
